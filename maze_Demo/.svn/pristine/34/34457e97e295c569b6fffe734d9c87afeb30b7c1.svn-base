 ...
 * It is traditional to denote a policy by ¦Ð, and ¦Ð(s) is the action 
 * recommended by the policy ¦Ð for state s. If the agent has a complete 
...
public interface Policy<S, A extends Action> { 
 /**
  * ¦Ð(s) is the action recommended by the policy ¦Ð for state s. 
  *  
  * @param s 
  *            the state s 
  * @return the action recommended by the policy ¦Ð for state s. 
  */ 
 A action(S s); 
}