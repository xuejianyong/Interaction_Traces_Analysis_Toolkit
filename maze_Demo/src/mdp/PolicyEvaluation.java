 ...
 * <br> 
 * Given a policy ¦Ð<sub>i</sub>, calculate 
 * U<sub>i</sub>=U<sup>¦Ð<sub>i</sub></sup>, the utility of each state if 
 * ¦Ð<sub>i</sub> were to be executed. 
 *  
 * @param <S> 
 *            the state type. 
 * @param <A> 
...
public interface PolicyEvaluation<S, A extends Action> { 
 /**
  * <b>Policy evaluation:</b> given a policy ¦Ð<sub>i</sub>, calculate 
  * U<sub>i</sub>=U<sup>¦Ð<sub>i</sub></sup>, the utility of each state if 
  * ¦Ð<sub>i</sub> were to be executed. 
  *  
  * @param pi_i 
  ...
  * @return U<sub>i</sub>=U<sup>¦Ð<sub>i</sub></sup>, the utility of each 
  *         state if ¦Ð<sub>i</sub> were to be executed. 
  */ 
